...
**Trigger for the next increment:** the same audit discipline applied to Today, Timeline, Goals, Learning, and Areas gets applied to the one screen still genuinely plain — Family Care — once there's real usage data suggesting it's actually the highest-value next redesign, rather than working the list top-to-bottom by assumption.
