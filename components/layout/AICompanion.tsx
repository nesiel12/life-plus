...
export function AICompanion() {
  ...
  return (
    <>
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="glass-card fixed bottom-24 right-6 z-50 flex h-[28rem] w-[22rem] flex-col rounded-2xl shadow-2xl sm:right-8"
          >
      ...
      <motion.button
        onClick={() => setOpen((v) => !v)}
        className="fixed bottom-6 right-6 z-50 flex size-14 items-center justify-center rounded-full bg-gradient-to-br from-accent-faith/80 to-accent-knowledge/80 text-background shadow-xl sm:right-8"
